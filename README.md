...
| bastion\_instances | List of droplet IDs to include in this security group | `list(string)` | `[]` | no |
...
| consul\_instances | List of droplet IDs to include in this security group | `list(string)` | `[]` | no |
...
| hids\_instances | List of droplet IDs to include in this security group | `list(string)` | `[]` | no |
...
| logging\_instances | List of droplet IDs to include in this security group | `list(string)` | `[]` | no |
...
| monitoring\_instances | List of droplet IDs to include in this security group | `list(string)` | `[]` | no |
...
| sentry\_node\_instances | List of droplet IDs to include in this security group | `list(string)` | `[]` | no |
...
| vault\_instances | List of droplet IDs to include in this security group | `list(string)` | `[]` | no |
